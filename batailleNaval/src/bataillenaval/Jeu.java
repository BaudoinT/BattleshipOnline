...
public class Jeu {
	...
	public void emplacementBateau(int longueur, int tourJ) {
		...
		return true;
	}}else if(sens.equals("vertical")){if(posX+longueur<=10){

	if(tourJoueur==0){for(

	int i = posX;i<posX+longueur;i++)
	...
	}return true;}}else{System.out.println("Cette place n'est pas valide !");return false;}return false;
